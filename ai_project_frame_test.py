...
class Damage_Selection_Jacket(ctk.CTkFrame):
    def __init__(self, *args, header_name="Jacket Damages", **kwargs):
        ...
        self.header_label.grid(row=0, column=0, columnspan=6, pady=10, sticky='ew')
        self.options = [
    ...
    def main_func(self):
        ...
        self.display_box = ctk.CTkFrame(self, height=150, width=300)
    ...
    def __init__(self, *args, **kwargs):
        ...
        for i, type in enumerate(types_list):
            if i % 3 == 0:
                r += 1
                c = 0
            type_opt = ctk.CTkRadioButton(self.type_frame, text=type, variable=types, value=type)
...
class AIApp(ctk.CTkFrame):
    def __init__(self, master=None, **kwargs):
        ...
        self.frames_ll = self.LL_Frames([self.description_frame, self.condition_frame, self.ai_frame])
    ...
    def build_second_frame(self):
        self.secondframe = ctk.CTkScrollableFrame(self, height=700, width=900, orientation='vertical')

        self.firstsection = Condition(self.secondframe)
        self.firstsection.grid(row=0, column=0, sticky='nsew')
        ...
        self.btns.grid(row=3, column=0, sticky='nsew')

        back_button = ctk.CTkButton(self.btns, text="Back", command=self.prev_frame)
        back_button.grid(row=0, column=0, columnspan=2, sticky='ew')

        next_button = ctk.CTkButton(self.btns, text="Next", command=self.next_frame)
        next_button.grid(row=0, column=2, columnspan=2, sticky='ew')
